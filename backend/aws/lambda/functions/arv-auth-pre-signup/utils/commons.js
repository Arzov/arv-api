...
const mt = {
    ...
    /**
     * Agregar usuario a AWS DynamoDB
     * @param {Object} db Conexion a DynamoDB
     * @param {String} tableName Nombre de la tabla
     * @param {String} hashKey Email del usuario
     ...
     * @param {Function} fn Función callback
     */
    addUser: (db, tableName, hashKey, registerDate, firstName, lastName, providers,
     ...
     * @param {Function} fn Función callback
     */
    updateUser: (db, tableName, hashKey, providers, providerId, verified, lastName, birthdate,
        gender, picture, fn) => {
        db.updateItem({
            TableName: tableName,
            Key: { "hashKey": { S: hashKey } },
